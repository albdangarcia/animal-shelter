...
import { FosterPlacementBanner } from "@/components/dashboard/animals/foster-placement-banner";
...
const AnimalSectionCards = async ({ params }: Props) => {
  ...
  // "currently in foster" is derived from an open placement, never
  // stored as a flag. At most one open placement can exist per animal.
  const openPlacement = animal.fosterPlacements[0] ?? null;
  const canPlaceInFoster =
    canManageFosters &&
    !openPlacement &&
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="@container/section-cards">
        <div className="grid grid-cols-1 gap-4 @[650px]/section-cards:grid-cols-2">
          ...
          <Card className="@container/card">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex flex-col items-center gap-4 @[400px]/card:flex-row @[400px]/card:items-start">
                ...
                <div className="grid w-full grid-cols-2 gap-2 text-sm @[400px]/card:w-auto @[400px]/card:flex-1">
              ...
              {canPlaceInFoster && (
                <Button asChild variant="outline" className="w-full">
                  <Link
                    href={`/dashboard/fosters/placements/new?animalId=${animal.id}`}
                  >
